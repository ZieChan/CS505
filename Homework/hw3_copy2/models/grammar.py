...
class PCFG(object):
    def __init__(self: Type["PCFG"]):
        ...
        self.productions_to_parent: Mapping[Tuple[str, ...], Set[str]] = defaultdict(set)
    ...
    def add_rule_parent(self: Type["PCFG"],
                 nonterm: str,
                 productions: Tuple[str, ...],
                 wt: int = 1
                 ) -> None:
        ...
        # self.productions_from[t.nonterm][t] += wt
        self.productions_to_parent[t.productions].add(nonterm)
    ...
    # def get_rules_to_parent(self: Type["PCFG"],
    #                  *symbols: Tuple[str] # *symbols will guarantee aguments are in tuple form
    #                  ) -> Sequence[Tuple[str, float]]:
    #     # for symb in symbols:
    #     #     if symb not in self.terminals and symb not in self.nonterminals:
